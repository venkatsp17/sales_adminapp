                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                height: height*5,
                                                width: width*25,
                                                child: Text(widget.data['products'][index]['details'][index1]['KG'].toString(),style: TextStyle(fontSize: width*1.2),),
                                              ),
                                              Container(
                                                alignment: Alignment.centerLeft,
                                                height: height*5,
                                                width: width*18,
                                                child: Text(widget.data['products'][index]['details'][index1]['qty'].toString(),style: TextStyle(fontSize: width*1.2)),
                                              ),
                                              Container(
                                                height: height*5,
                                                width: width*20,
                                                alignment: Alignment.center,
                                                child: Text(widget.data['products'][index]['details'][index1]['rate'].toString(),style: TextStyle(fontSize: width*1.2)),
                                              ),
                                              Container(
                                                height: height*5,
                                                width: width*20,
                                                alignment: Alignment.centerRight,
                                                child: Text(widget.data['products'][index]['details'][index1]['amount'].toString(),style: TextStyle(fontSize: width*1.2)),
                                              ),
                                            ],
                                          ),
                                        );
