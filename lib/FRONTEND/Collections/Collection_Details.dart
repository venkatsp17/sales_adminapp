                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () {
                            ...
                            Navigation.homeNavigation.currentState?.push(MaterialPageRoute(builder: (BuildContext context)=>Customerdetails(data: customer,)));
                          },
                          child: const Text(
                            'more details>>',
                        ...
                        children: [
                          TextButton(
                            onPressed: () {
                              try{
                                if(order.isNotEmpty){
                                  Navigation.homeNavigation.currentState?.push(MaterialPageRoute(builder: (BuildContext context)=>Orderdetails(data: order,)));
                                }
                              }
                              catch(e){
                            ...
                            onPressed: () {
                              try{
                                if(payment.isNotEmpty){
                                  Navigation.homeNavigation.currentState?.push(MaterialPageRoute(builder: (BuildContext context)=>Paymentdetails(data: payment,)));
                                }
                              }
                              catch(e){
